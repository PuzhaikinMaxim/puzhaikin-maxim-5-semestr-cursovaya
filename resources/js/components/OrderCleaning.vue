<template>
    ...
    <header class="header">
            ...
            <div class="header__links">
                <router-link to="/userWelcomePage"><a href="#">Активные заказы</a></router-link>
                <router-link to="/orderCleaning"><a href="#">Сделать заказ</a></router-link>
                <router-link to="/makeReview"><a href="#">Оставить отзыв</a></router-link>
